...
[task_local]
#注销京东会员卡
55 23 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_unbind.js, tag=注销京东会员卡, enabled=true
=======Loon========
[Script]
cron "55 23 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_unbind.js,tag=注销京东会员卡
========Surge==========
注销京东会员卡 = type=cron,cronexp="55 23 * * *",wake-system=1,timeout=620,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_unbind.js
=======小火箭=====
注销京东会员卡 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_unbind.js, cronexpr="10 23 * * *", timeout=200, enable=true
 */
...
async function unsubscribeCards() {
  ...
  if (push_lena == 0) {
    ...
    await notify.sendNotify(`京东会员卡注消链接`, `${$.UserName}\n${tg_text}`);
  } else {
    let step = 0
