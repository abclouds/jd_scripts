...
[task_local]
#东东玩家
20 5 * * * jd_ddwj.js, tag= 东东玩家
================Loon==============
[Script]
cron "20 5 * * *" script-path= jd_ddwj.js,tag= 东东玩家
===============Surge=================
东东玩家 = type=cron,cronexp="20 0 * * *",wake-system=1,timeout=3600,script-path= jd_ddwj.js
============小火箭=========
东东玩家 = type=cron,script-path= jd_ddwj.js, cronexpr="20 0 * * *", timeout=3600, enable=true
*/
const $ = new Env('东东玩家')
