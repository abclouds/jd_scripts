...
[task_local]
#半点京豆雨
30 16-23/1 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_half.js, tag=半点京豆雨, enabled=true

================Loon==============
[Script]
cron "30 16-23/1 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_half.js,tag=半点京豆雨

===============Surge=================
 半点京豆雨 = type=cron,cronexp="30 16-23/1 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_half.js

============小火箭=========
 半点京豆雨= type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_half.js, cronexpr="30 16-23/1 * * *",timeout=200, enable=true
 */
const $ = new Env('半点京豆雨');
let allMessage = '';
let bodyList = {
...
function rraUrl() {
    let url = 'https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_half.json'
