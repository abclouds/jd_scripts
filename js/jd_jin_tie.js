...
[task_local]
#领金贴
10 0 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jin_tie.js, tag=领金贴, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon===============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jin_tie.js,tag=领金贴
=======Surge===========
领金贴 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jin_tie.js
==============小火箭=============
领金贴 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jin_tie.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  if (!cookiesArr[0]) {
    $.msg($.name, '【提示】请先获取京东账号一cookie\n直接京东签到获取', 'https://bean.m.jd.com/bean/signIndex.action', {"open-url": "https://bean.m.jd.com/bean/signIndex.action"});
    return;
  }
