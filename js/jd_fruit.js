/*
东东水果:脚本更新地址 https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_fruit.js
更新时间：2021-5-18
...
[task_local]
#jd免费水果
5 6-18/6 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_fruit.js, tag=东东农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 6-18/6 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 6-18/6 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_fruit.js

=========================小火箭===========================
东东农场 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_fruit.js, cronexpr="5 6-18/6 * * *", timeout=3600, enable=true
...
let shareCodes = [
   'e288e93253774d89a74ba7ca1775bca6@e288e93253774d89a74ba7ca1775bca6@c3679844baa94eb387bc456996bbf05b@9a230ac02ca1493a8398691ecfa8a3c2@6d0657c0eb99406b87eadb2577b13b4c'
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    const jdFruitShareCodes = $.isNode() ? require('./help/jdFruitShareCodes.js') : '';
