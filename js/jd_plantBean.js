/*
种豆得豆 脚本更新地址：https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_plantBean.js
更新时间：2021-04-9
...
=====================================Quantumult X=================================
[task_local]
1 7-21/2 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_plantBean.js, tag=种豆得豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzd.png, enabled=true

=====================================Loon================================
[Script]
cron "1 7-21/2 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_plantBean.js,tag=京东种豆得豆

======================================Surge==========================
京东种豆得豆 = type=cron,cronexp="1 7-21/2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_plantBean.js

====================================小火箭=============================
京东种豆得豆 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_plantBean.js, cronexpr="1 7-21/2 * * *", timeout=3600, enable=true
...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'olmijoxgmjutzu6bimv3bnztlk3oaz3vcrwmpvq@e7lhibzb3zek2sas67y7czw2j6lby4cula77gsi@t4udt7jiwj7jwnvjivua3zp2oiplrvm4yl2nf2a@rpqcuilrh6bw6awwlhjt3kcaaa@7oivz2mjbmnx4zpyibadutgjqzzvdklkgnrpmay@wsr6thb5bd25lt2zry4pco2ycyhqkbg7f3rw33i'
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    const jdPlantBeanShareCodes = $.isNode() ? require('./help/jdPlantBeanShareCodes.js') : '';
