/*
东东萌宠 更新地址： https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_pet.js
更新时间：2021-05-21
...
[task_local]
#东东萌宠
15 6-18/6 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_pet.js, tag=东东萌宠, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdmc.png, enabled=true

=================================Loon===================================
[Script]
cron "15 6-18/6 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_pet.js,tag=东东萌宠

===================================Surge================================
东东萌宠 = type=cron,cronexp="15 6-18/6 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_pet.js

====================================小火箭=============================
东东萌宠 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_pet.js, cronexpr="15 6-18/6 * * *", timeout=3600, enable=true
...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'MTE1NDQ5OTIwMDAwMDAwNDA0MTQyMjU=@MTEzMzI0OTE0NTAwMDAwMDA0MDg2NjkzMQ==@MTE0MDkyMjIwMDAwMDAwNDcyNDk2Mzc=@MTEzMzI1MTE4NDAwMDAwMDA0OTY5Nzc0Mw==@MTEzMzI1MTE4NDAwMDAwMDA1NDQyMTk3NQ=='
]
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    const jdPetShareCodes = $.isNode() ? require('./help/jdPetShareCodes.js') : '';
