 ...
 * @param author 作者仓库等信息  例：`本脚本免费使用 By：https://github.com/abclouds`
...
// =======================================telegram机器人通知设置区域===========================================
//此处填你telegram bot 的Token，telegram机器人通知推送必填项.例如：1077xxx4424:xxx
//(环境变量名 TG_BOT_TOKEN)
let TG_BOT_TOKEN = '';
...
// =======================================企业微信机器人通知设置区域===========================================
//此处填你企业微信机器人的 webhook(详见文档 https://work.weixin.qq.com/api/doc/90000/90136/91770)，例如：xxxx
//(环境变量名 QYWX_KEY)
let QYWX_KEY = '';
 ...
 * @returns {Promise<unknown>}
 */
async function sendNotify(text, desp, params = {}, author = '\n\n本脚本免费使用 By：https://github.com/abclouds') {
    //提供6种通知
    ...
    return new class {
        ...
        runScript(t, s) {
            return new Promise(e => {
                ...
                i = i ? i.replace(/\n/g, "").trim() : i;
                let o = this.getdata("@abclouds_boxjs_userCfgs.httpapi_timeout");
