...
脚本兼容: Node.js
 ...
 [task_local]
 #美丽研究院
 1 7,12,19 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_beauty.js, tag=美丽研究院, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdmc.png, enabled=true

 =================================Loon===================================
 [Script]
 cron " 1 7,12,19 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_beauty.js,tag=美丽研究院

 ===================================Surge================================
 美丽研究院 = type=cron,cronexp=" 1 7,12,19 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_beauty.js

 ====================================小火箭=============================
 美丽研究院 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_beauty.js, cronexpr=" 1 7,12,19 * * *", timeout=3600, enable=true
