 ...
 *
 ...
 Quantumult X:
 [task_local]
 0 * * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jx_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

 [rewrite_local]
 ^https\:\/\/wq\.jd\.com\/cubeactive\/farm\/dotask url script-request-header https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js
 ^https\:\/\/m\.jingxi\.com\/dreamfactory\/generator\/CollectCurrentElectricity url script-request-header https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js
 ^https\:\/\/m\.jingxi\.com\/jxcfd\/consume\/CashOut url script-request-header https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js

 Loon:
 [Script]
 http-request ^https\:\/\/wq\.jd\.com\/cubeactive\/farm\/dotask script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js, requires-body=false, timeout=10, tag=京喜token
 http-request ^https\:\/\/m\.jingxi\.com\/dreamfactory\/generator\/CollectCurrentElectricity script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js, requires-body=false, timeout=10, tag=京喜token
 http-request ^^https\:\/\/m\.jingxi\.com\/jxcfd\/consume\/CashOut script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js, requires-body=false, timeout=10, tag=京喜token
 cron "0 * * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jx_cfd.js,tag=京喜财富岛

 Surge:
 京喜财富岛 = type=cron,cronexp="0 * * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jx_cfd.js
 京喜token = type=http-request,pattern=^https\:\/\/wq\.jd\.com\/cubeactive\/farm\/dotask,requires-body=0,max-size=0,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js
 京喜token = type=http-request,pattern=^https\:\/\/m\.jingxi\.com\/dreamfactory\/generator\/CollectCurrentElectricity,requires-body=0,max-size=0,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js
 京喜token = type=http-request,pattern=^https\:\/\/m\.jingxi\.com\/jxcfd\/consume\/CashOut,requires-body=0,max-size=0,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js

 Shadowrocket:
 [Script]
 京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jx_cfd.js,cronexpr="0 * * * *",timeout=120,enable=true
 京喜token = type=http-request,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js,pattern=^https\:\/\/wq\.jd\.com\/cubeactive\/farm\/dotask,max-size=131072,timeout=10,enable=true
 京喜token = type=http-request,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js,pattern=^https\:\/\/m\.jingxi\.com\/dreamfactory\/generator\/CollectCurrentElectricity,max-size=131072,timeout=10,enable=true
 京喜token = type=http-request,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/jx_tokens.js,pattern=^https\:\/\/m\.jingxi\.com\/jxcfd\/consume\/CashOut,max-size=131072,timeout=10,enable=true

 BoxJS订阅
 https://raw.githubusercontent.com/abclouds/jd_scripts/master/whyour.boxjs.json
 ...
 ## TOKEN如何获取请阅读以下文件的注释：jd_jxnc.js
