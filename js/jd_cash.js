...
[task_local]
#签到领现金
2 0-23/4 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_cash.js, tag=签到领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "2 0-23/4 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_cash.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="2 0-23/4 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_cash.js

============小火箭=========
签到领现金 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_cash.js, cronexpr="2 0-23/4 * * *", timeout=3600, enable=true
 */
/*
签到领现金，每日2毛～5毛
可互助，助力码每日不变，只变日期
...
const inviteCodes = [
  'eU9Yar6yb_gjoG_dy3IQ3g@eU9YaOW1YPUk82uHy3JGgg@9qSsuGcCsnWeJPtYHtKB3lSqMQ@cEppOKXhOqNjpS0'
]
if ($.isNode()) {
...
function shareCodesFormat() {
  return new Promise(async resolve => {inviteCodes
