...
[task_local]
#京喜工厂
10 * * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_dreamFactory.js, tag=京喜工厂, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "10 * * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_dreamFactory.js,tag=京喜工厂

===============Surge=================
京喜工厂 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_dreamFactory.js

============小火箭=========
京喜工厂 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_dreamFactory.js, cronexpr="10 * * * *", timeout=3600, enable=true
...
const inviteCodes = [
  'jM3F0_2fV3_rS-biZmGuWQ==@IDaycE5S4qwCcPQbuyvpmQ==@lPRAGGCrr7tqCONUo430VGgcFS9AOKADxN2FgPQJsEc=@telbbn4QefQp27ipu0z-zg=='
];
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    const shareCodes = $.isNode() ? require('./help/jdDreamFactoryShareCodes.js') : '';
