...
[task_local]
#整点京豆雨
1 0-23/1 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_super.js, tag=整点京豆雨, enabled=true

================Loon==============
[Script]
cron "1 0-23/1 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_super.js,tag=整点京豆雨

===============Surge=================
 整点京豆雨 = type=cron,cronexp="1 0-23/1 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_super.js

============小火箭=========
 整点京豆雨= type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_super.js, cronexpr="1 0-23/1 * * *",timeout=200, enable=true
 */
const $ = new Env('整点京豆雨');
let allMessage = '';
let bodyList = {
...
function rraUrl() {
    let url = 'https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_live_redrain_super.js.json'
