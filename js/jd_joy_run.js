/*
 * @Author: abclouds https://github.com/abclouds/jd_scripts/master
 * @Date: 2021-05-14
...
docker 设置环境变量 JOY_RUN_HELP_MYSELF 为true,则开启账号内部互助.默认关闭.
...
===========Surge=================
[Script]
宠汪汪邀请助力与赛跑助力 = type=cron,cronexp="15 10 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js
宠汪汪助力更新Token = type=http-response,pattern=^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/addUser\?code=, requires-body=1, max-size=0, script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js
宠汪汪助力获取Token = type=http-request,pattern=^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/user\/detail\?openId=, max-size=0, script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js

===================Quantumult X=====================
[task_local]
# 宠汪汪邀请助力与赛跑助力
15 10 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
[rewrite_local]
# 宠汪汪助力更新Token
^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/addUser\?code= url script-response-body https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js
# 宠汪汪助力获取Token
^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/user\/detail\?openId= url script-request-header https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js

=====================Loon=====================
[Script]
cron "15 10 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力
http-response ^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/addUser\?code= script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js, requires-body=true, timeout=10, tag=宠汪汪助力更新Token
http-request ^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/user\/detail\?openId= script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_joy_run.js, timeout=3600, tag=宠汪汪助力获取Token
*/
const $ = new Env('宠汪汪赛跑');
...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_6b0945a180138,jd_49769225b01ed,%E5%8F%AB%E4%BB%80%E4%B9%88%E5%A5%BD%E5%91%A28370,candyclouds,jd_kIqgytmYSiEK,jd_jguEvlqOKpyt'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_6b0945a180138,jd_49769225b01ed,%E5%8F%AB%E4%BB%80%E4%B9%88%E5%A5%BD%E5%91%A28370,candyclouds,jd_kIqgytmYSiEK,jd_jguEvlqOKpyt'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["jd_6b0945a180138", "jd_49769225b01ed", "%E5%8F%AB%E4%BB%80%E4%B9%88%E5%A5%BD%E5%91%A28370", "candyclouds", "jd_kIqgytmYSiEK", "jd_jguEvlqOKpyt"]
