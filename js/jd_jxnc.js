...
京喜农场:脚本更新地址 https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jxnc.js
更新时间：22021-06-3
活动入口：京喜APP我的-京喜农场
...
==========================Quantumultx=========================
[task_local]
0 9,12,18 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jxnc.js, tag=京喜农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxnc.png, enabled=true
=========================Loon=============================
[Script]
cron "0 9,12,18 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jxnc.js,tag=京喜农场

=========================Surge============================
京喜农场 = type=cron,cronexp="0 9,12,18 * * *",timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jxnc.js

=========================小火箭===========================
京喜农场 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_jxnc.js, cronexpr="0 9,12,18 * * *", timeout=3600, enable=true
*/
...
function requireConfig() {
    return new Promise(async resolve => {
        ...
        const jdJxncShareCodeNode = $.isNode() ? require('./help/jdJxncShareCodes.js') : {};
