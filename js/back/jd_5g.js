...
[task_local]
#5G狂欢城
0 0,6,12,18 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_5g.js, tag=5G狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "0 0,6,12,18 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_5g.js, tag=5G狂欢城

===============Surge=================
5G狂欢城 = type=cron,cronexp="0 0,6,12,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_5g.js

============小火箭=========
5G狂欢城 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_5g.js, cronexpr="0 0,6,12,18 * * *", timeout=3600, enable=true
 */
const $ = new Env('5G狂欢城');
