...
[task_local]
#crazyJoy任务
10 9 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_crazy_joy.js, tag=crazyJoy任务, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_crazy_joy.png, enabled=true

================Loon==============
[Script]
cron "10 9 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_crazy_joy.js,tag=crazyJoy任务

===============Surge=================
crazyJoy任务 = type=cron,cronexp="10 9 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_crazy_joy.js

============小火箭=========
crazyJoy任务 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_crazy_joy.js, cronexpr="10 9 * * *", timeout=3600, enable=true
...
const inviteCodes = [
  '7MzDdYPADuZybw6g4y9lQat9zd5YaBeE@SNuP22Z-yiOa4oEMCXTgUqt9zd5YaBeE@y9LoNFB4cox-Lq71WHPlKQQOHL5XShzX@1mmFjHBSq_BSYYQehRdL6Q=='
];
