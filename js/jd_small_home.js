 ...
 */
/*
东东小窝 https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_small_home.js
现有功能：
...
[task_local]
#东东小窝
16 22 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_small_home.js, tag=东东小窝, img-url=https://raw.githubusercontent.com/58xinian/icon/master/ddxw.png, enabled=true

================Loon==============
[Script]
cron "16 22 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_small_home.js, tag=东东小窝

===============Surge=================
东东小窝 = type=cron,cronexp="16 22 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_small_home.js

============小火箭=========
东东小窝 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_small_home.js, cronexpr="16 22 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东小窝');

//IOS等用户直接用NobyDa的jd cookie
let cookiesArr = [], cookie = '', message = '',notify;
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    console.log(`共${cookiesArr.length}个京东账号\n`)
     $.inviteCodes = await getAuthorShareCode('https://raw.githubusercontent.com/FearNoManButGod/AuthorCode/main/jd_smallHome.json')
	  if (!$.inviteCodes) {
		$.http.get({url: 'https://purge.jsdelivr.net/gh/FearNoManButGod/AuthorCode@main/jd_smallHome.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
		await $.wait(1000)
		$.inviteCodes = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/FearNoManButGod/AuthorCode@main/jd_smallHome.json')
	  }
    resolve()
  })
}
