...
[task_local]
#新潮品牌狂欢
4 10 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_mcxhd.js, tag=新潮品牌狂欢, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "4 10 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_mcxhd.js,tag=新潮品牌狂欢

================Surge===============
新潮品牌狂欢 = type=cron,cronexp="4 10 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_mcxhd.js

===============小火箭==========
新潮品牌狂欢 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_mcxhd.js, cronexpr="4 10 * * *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  $.shareCodeList = [
      '43xA_erJaPow6F86M-TPvAhDVmBfQFYMVw0TRgChZDpiFEXanOJfviqaD4mHhlxMzSyQ','43xA_erJaPow6F86M-TF-Qeaj45WsB7pnEnMxauCcJaGS8XanOJ6Dlpq159D_vZPUDQA',
  ]
