...
活动入口：京东APP首页-领京豆
更新地址：https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_bean_home.js
已支持IOS双京东账号, Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, 小火箭，JSBox, Node.js
============Quantumultx===============
[task_local]
#领京豆额外奖励
10 7 * * * https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_bean_home.js, tag=领京豆额外奖励, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_bean_home.png, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_bean_home.js, tag=领京豆额外奖励

===============Surge=================
领京豆额外奖励 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_bean_home.js

============小火箭=========
领京豆额外奖励 = type=cron,script-path=https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/jd_bean_home.js, cronexpr="10 7 * * *", timeout=3600, enable=true
 */
...
!(async () => {
    ...
    if (!cookiesArr[0]) {
        $.msg($.name, '【提示】请先获取京东账号一cookie', 'https://bean.m.jd.com/bean/signIndex.action', {"open-url": "https://bean.m.jd.com/bean/signIndex.action"});
        return;
    }
...
function getAuthorShareCode() {
    return new Promise(resolve => {
        $.get({
            url: "https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/help/jd_bean_home_help.js", headers: {
...
function getAuthorShareCode2() {
    return new Promise(resolve => {
        $.get({
            url: "https://raw.githubusercontent.com/abclouds/jd_scripts/master/js/help/jd_bean_home_help2.json", headers: {
                "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
            }
        }, async (err, resp, data) => {
            try {
